...
//	        			 Service_Access_Path = "없음";
			...
			if( Institution.length() > 100 ||  Institution_Department.length() > 100  ||  Institution_Location_OR_UserResidence.length() > 100
				|| Duty_OR_Research.length() > 100 || Key_Issuance_Purpose.length() > 100 || Service_Access_Path.length() > 100 ) 
			{
				Institution_Department = "관리자가 확인 필요(질문 형식 다름 또는 형식 미준수)";
				Institution_Location_OR_UserResidence = "관리자가 확인 필요(질문 형식 다름 또는 형식 미준수)";
