...
//		File file = new File("C:\\Users\\byeonghooh\\eclipse-workspace\\Java_Reading_Txtfile_Text_01\\4.combine\\UserData.csv");
		File file = new File(
				"C:\\Users\\byeonghooh\\eclipse-workspace\\Java_Reading_Txtfile_Text_01\\combine\\More1\\UserData.csv");
...
//				}
				...
				if (s.contains("1)") && (s.contains("부서:") || s.contains("부서 :"))
					...
					if (subText_Institution_Department.contains("지역") && (subText_Institution_Department.contains("2)")
...
//			}
//			
			System.out.println(User_Divider + " :" + User_Name + " :" + Email_Address + " :" + Institution + " :"
					+ Institution_Department + " :" + Institution_Location_OR_UserResidence);
			System.out.println(Duty_OR_Research + " :" + Key_Issuance_Purpose + " :" + Service_Access_Path + " :"
					+ Institution_Information_Homepage_Address);
//			
//			
